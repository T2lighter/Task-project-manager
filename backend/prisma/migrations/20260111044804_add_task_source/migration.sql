...
INSERT INTO "new_Task" ("categoryId", "createdAt", "description", "dueDate", "id", "importance", "parentTaskId", "projectId", "status", "title", "updatedAt", "urgency", "userId") SELECT "categoryId", "createdAt", "description", "dueDate", "id", "importance", "parentTaskId", "projectId", "status", "title", "updatedAt", "urgency", "userId" FROM "Task";
DROP TABLE "Task";
